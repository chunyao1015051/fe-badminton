  ...
  <v-container class="mt-5">
    <v-row justify="center" dense>
      ...
      <v-col
        cols="12"
        class="text-center"
        style="position: relative; top: 96px; margin-top: -90px"
      >
        <svg
          width="100"
          height="100"
        ...
        >
          ...
          <path
            class="st23"
            d="M72,106H56c-2.2,0-4-1.8-4-4v-3c0-2.2,1.8-4,4-4h16c2.2,0,4,1.8,4,4v3C76,104.2,74.2,106,72,106z"
          />
          <rect class="st16" height="16.5" width="10.5" x="58.8" y="68.5" />
          <rect class="st24" height="16.5" width="3" x="66.2" y="68.5" />
          <path
            class="st14"
            d="M73,84H55c-3.3,0-6,2.7-6,6v0h30v0C79,86.7,76.3,84,73,84z"
          />
          <path class="st15" d="M73,84h-5c3.3,0,6,2.7,6,6h5C79,86.7,76.3,84,73,84z" />
          <path
            class="st14"
            d="M69.1,77H58.9c-2.7,0-4.9-2.2-4.9-4.9V71h20v1.1C74,74.8,71.8,77,69.1,77z"
          />
          <path
            class="st15"
            d="M70,71v1.1c0,2.7-1.2,4.9-3.9,4.9h3c2.7,0,4.9-2.2,4.9-4.9V71H70z"
          />
          <path
            class="st16"
            d="M81,90H47l0,0c0-1.1,0.9-2,2-2h30C80.1,88,81,88.9,81,90L81,90z"
          />
          ...
          <path
            class="st14"
            d="M72.5,72h-17C49.1,72,44,66.9,44,60.5V29h40v31.5C84,66.9,78.9,72,72.5,72z"
          />
          <path class="st10" d="M50,32c0,0,0,17,0,20" />
          <path
            class="st15"
            d="M79,29v31.5C79,66.9,73.9,72,67.5,72h5C78.9,72,84,66.9,84,60.5V29H79z"
          />
          <polygon class="st16" points="87,29 41,29 44,32 84,32 " />
          <polygon class="st24" points="81,29 79,32 84,32 87,29 " />
          <path
            class="st14"
            d="M88,25H40c-1.1,0-2,0.9-2,2v0c0,1.1,0.9,2,2,2h48c1.1,0,2-0.9,2-2v0C90,25.9,89.1,25,88,25z"
          />
          <path
            class="st15"
            d="M88,25h-6c1.1,0,2,0.9,2,2c0,1.1-0.9,2-2,2h6c1.1,0,2-0.9,2-2C90,25.9,89.1,25,88,25z"
          />
                ...
                <v-row class="mt-3">
                  ...
                  <v-col col="12">
                    <v-btn
                      ...
                      block
                      :disabled="
                        !group_one || !group_two || !group_one_scores || !group_two_scores
                      "
                      @click="updateScores()"
                      >送出</v-btn
                    >
...
export default {
  ...
  methods: {
    ...
    async updateScores() {
      ...
      try {
        await axios.post(`http://${process.env.SERVER_HOST}/updateScores/幼幼班`, {
