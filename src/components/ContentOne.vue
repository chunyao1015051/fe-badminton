    ...
    <v-row justify="center" dense>
      ...
      <v-col cols="12" class="text-center mt-3">
        <svg width="330" height="280" viewBox="50 0 300 300">
          ...
          <text x="85" y="145" font-family="Verdana" font-size="20" fill="black">F</text>
          ...
          <text x="355" y="260" font-family="Verdana" font-size="20" fill="black">A</text>
...
export default {
  ...
  methods: {
    ...
    async getStatus() {
      const { data } = await axios.get(
        `http://${process.env.SERVER_HOST}/getStatus/幼幼班`
      );
      const { nowLeft,
        nowRight,
        nextLeft,
    ...
    async updateSatus() {
      ...
      try {
        await axios.post(`http://${process.env.SERVER_HOST}/updateStatus/幼幼班`, {
